...
INSERT IGNORE product_db.user (id, email, password, first_name, last_name, id_address, role)  values (1, 'Jhon@Hotmail.com', '$2a$10$iF/AFMpI1Lq66EGJW/MzG.KtJQApEwKHI4n.d5T713TDVZAM/MkNu', 'Jhon','Gates',1, 'ADMIN');
INSERT IGNORE product_db.user (id, email, password, first_name, last_name, id_address, role)  values (2, 'Keith@Hotmail.com', '$2a$10$iF/AFMpI1Lq66EGJW/MzG.KtJQApEwKHI4n.d5T713TDVZAM/MkNu', 'Keith','Routh',2, 'USER');
INSERT IGNORE product_db.user (id, email, password, first_name, last_name, id_address, role) values (3, 'James@Hotmail.com', '$2a$10$iF/AFMpI1Lq66EGJW/MzG.KtJQApEwKHI4n.d5T713TDVZAM/MkNu', 'James','Morono',1, 'ADMIN');
